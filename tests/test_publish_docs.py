...
def test_a_patch_tagged_after_a_later_release_does_not_take_stable_back(publisher, tmp_path):
    site = tmp_path / "site"
...
def test_the_site_keeps_only_the_newest_releases_beside_latest_and_stable(publisher, tmp_path):
...
def test_stable_survives_a_prune_that_removes_its_own_tag_directory(publisher, tmp_path):
